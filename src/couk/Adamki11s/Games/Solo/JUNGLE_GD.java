...
public class JUNGLE_GD extends Gamedata{
	...
	private Location sign1 = new Location(Maps.Warzone_World, -87.5D, 73.620000000000005D, 104.5D);
	private Location sign2 = new Location(Maps.Warzone_World, -110.5D, 73.620000000000005D, 140.5D);
	...
	public void tickerTask(int schedulerTask) {
		...
		this.s1.setLine(2, ChatColor.DARK_PURPLE + "Time Left");
	    this.s2.setLine(2, ChatColor.DARK_PURPLE + "Time Left");
	    this.s1.setLine(3, ChatColor.DARK_PURPLE + "" + (gameTime - this.timer) + "");
	    this.s2.setLine(3, ChatColor.DARK_PURPLE +  "" + (gameTime - this.timer) + "");
	    s1.update();
	    s2.update();
